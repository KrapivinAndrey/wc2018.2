...
Процедура ДрафтТаран()
	...
	// Корабль1 = СобратьКорабльТарана(1, 2, 3);  //  X - количество блоков здоровья , Y - максимальное ускорение двигателя , Z - количество носов
	Корабль2 = СобратьКорабльТарана(2, 1, 1); 
	...
	КонецЕсли;
	// 6 штук Корабль2
	ВыбратьКорабль(Корабль2["Id"], "0/" + КоординатаY + "/" + КоординатаZ, Корабль2["Equipment"]);
	ВыбратьКорабль(Корабль2["Id"], "3/" + КоординатаY + "/" + КоординатаZ, Корабль2["Equipment"]);
	ВыбратьКорабль(Корабль2["Id"], "6/" + КоординатаY + "/" + КоординатаZ, Корабль2["Equipment"]);
	ВыбратьКорабль(Корабль2["Id"], "9/" + КоординатаY + "/" + КоординатаZ, Корабль2["Equipment"]);
	ВыбратьКорабль(Корабль2["Id"], "12/" + КоординатаY + "/" + КоординатаZ, Корабль2["Equipment"]);
	ВыбратьКорабль(Корабль2["Id"], "15/" + КоординатаY + "/" + КоординатаZ, Корабль2["Equipment"]);
	ВыбратьКорабль(Корабль2["Id"], "18/" + КоординатаY + "/" + КоординатаZ, Корабль2["Equipment"]);	
	ВыбратьКорабль(Корабль2["Id"], "21/" + КоординатаY + "/" + КоординатаZ, Корабль2["Equipment"]);	
	ВыбратьКорабль(Корабль2["Id"], "24/" + КоординатаY + "/" + КоординатаZ, Корабль2["Equipment"]);	
	ВыбратьКорабль(Корабль2["Id"], "27/" + КоординатаY + "/" + КоординатаZ, Корабль2["Equipment"]);	

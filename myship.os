...
Функция Мушки(Корабли, Ответ)
	...
	Для каждого Корабль из Корабли Цикл 
		...
		РастояниеДодальней = Макс(Позиция.X, Позиция.Y, Позиция.Z);

		Если РастояниеДодальней = Позиция.X Тогда 
			РандомY = ГСЧ.СлучайноеЧисло(0, 30);
			РандомZ = ГСЧ.СлучайноеЧисло(0, 30);
		...
		Если РастояниеДодальней = Позиция.Y Тогда 
			РандомX = ГСЧ.СлучайноеЧисло(0, 30);
			РандомZ = ГСЧ.СлучайноеЧисло(0, 30);
...
Функция ПодготовитьОтвет()
	...
	//МыНаходимсяУСтены_ЕслиНетПоехалиКСтене(Корабли, Ответ);
	Мушки(Корабли, Ответ);

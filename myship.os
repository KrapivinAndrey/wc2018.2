...
Функция ПодготовитьОтвет()
	...
	Отладка.Добавить(ПарсерJSON.записатьJSON(Состояние));
	Отладка.Добавить(ПарсерJSON.записатьJSON(Состояние));
	Отладка.Добавить(ПарсерJSON.записатьJSON(Состояние));
	Отладка.Добавить(ПарсерJSON.записатьJSON(Состояние));
	Отладка.Добавить(ПарсерJSON.записатьJSON(Состояние));
	Отладка.Добавить("123123");
	Отладка.Добавить("123aad123");
	Отладка.Добавить("123adad123");
	Отладка.Добавить("adadasd");
	Отладка.Добавить("123123");
	Отладка.Добавить("123adasd123");
	Отладка.Добавить("123adad123");
	Отладка.Добавить("123123");
	Отладка.Добавить("12adasd3123");
	Отладка.Добавить("123asdads123");
	Отладка.Добавить("123asdad123");
	Отладка.Добавить("123adasd123");

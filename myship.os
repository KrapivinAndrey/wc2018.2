...
Функция МассивКоординатКорабля(Знач ПозицияКорабля)

	Если ТипЗнч(ПозицияКорабля) = Тип("Срока") Тогда
		ПозицияКорабля = НовыйВектор(ПозицияКорабля);
	КонецЕсли;

	Ячейка1 = ПозицияКорабля;
	Ячейка2 = НовыйВектор(ПозицияКорабля.Х + 1, ПозицияКорабля.Y   , ПозицияКорабля.Z);
	Ячейка3 = НовыйВектор(ПозицияКорабля.Х 	  , ПозицияКорабля.Y +1, ПозицияКорабля.Z);
	Ячейка4 = НовыйВектор(ПозицияКорабля.Х + 1, ПозицияКорабля.Y +1, ПозицияКорабля.Z);
	Ячейка5 = НовыйВектор(ПозицияКорабля.Х    , ПозицияКорабля.Y   , ПозицияКорабля.Z + 1);
	Ячейка6 = НовыйВектор(ПозицияКорабля.Х + 1, ПозицияКорабля.Y   , ПозицияКорабля.Z + 1);
	Ячейка7 = НовыйВектор(ПозицияКорабля.Х 	  , ПозицияКорабля.Y +1, ПозицияКорабля.Z + 1);
	Ячейка8 = НовыйВектор(ПозицияКорабля.Х + 1, ПозицияКорабля.Y +1, ПозицияКорабля.Z + 1);

	МассивКоординат = Новый Массив;
	МассивКоординат.Добавить(ВекторСтрокой(Ячейка1));
	МассивКоординат.Добавить(ВекторСтрокой(Ячейка2));
	МассивКоординат.Добавить(ВекторСтрокой(Ячейка3));
	МассивКоординат.Добавить(ВекторСтрокой(Ячейка4));
	МассивКоординат.Добавить(ВекторСтрокой(Ячейка5));
	МассивКоординат.Добавить(ВекторСтрокой(Ячейка6));
	МассивКоординат.Добавить(ВекторСтрокой(Ячейка7));
	МассивКоординат.Добавить(ВекторСтрокой(Ячейка8));

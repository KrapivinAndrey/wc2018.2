...
Функция МассивКоординатКорабля(Знач ПозицияКорабля, ЭлементыСтроки = Ложь)
	...
	МассивКоординат.Добавить(НовыйВектор(ПозицияКорабля.Х + 1, ПозицияКорабля.Y   , ПозицияКорабля.Z	));
	МассивКоординат.Добавить(НовыйВектор(ПозицияКорабля.Х 	 , ПозицияКорабля.Y +1, ПозицияКорабля.Z	));
	МассивКоординат.Добавить(НовыйВектор(ПозицияКорабля.Х + 1, ПозицияКорабля.Y +1, ПозицияКорабля.Z	));
	МассивКоординат.Добавить(НовыйВектор(ПозицияКорабля.Х    , ПозицияКорабля.Y   , ПозицияКорабля.Z + 1));
	МассивКоординат.Добавить(НовыйВектор(ПозицияКорабля.Х + 1, ПозицияКорабля.Y   , ПозицияКорабля.Z + 1));
	МассивКоординат.Добавить(НовыйВектор(ПозицияКорабля.Х 	 , ПозицияКорабля.Y +1, ПозицияКорабля.Z + 1));
	МассивКоординат.Добавить(НовыйВектор(ПозицияКорабля.Х + 1, ПозицияКорабля.Y +1, ПозицияКорабля.Z + 1));
...
Функция РасстояниеМеждуКораблямиОбъект(Знач ПозицияКорабля1, Знач ПозицияКорабля2)
	...
	Если ТипЗнч(ПозицияКорабля1) = Тип("Срока") Тогда
		ПозицияКорабля1 = НовыйВектор(ПозицияКорабля1);
	КонецЕсли;

	Если ТипЗнч(ПозицияКорабля2) = Тип("Срока") Тогда
	...
	ТаблицаРезультатов.Колонки.Добавить("ПозицияКорабля1");
	ТаблицаРезультатов.Колонки.Добавить("ПозицияКорабля2");
	...
	Для Каждого ЯчейкаКорабля1 Из МассивКоординатКорабля1 Цикл
		...
		Для Каждого ЯчейкаКорабля2 Из МассивКоординатКорабля2 Цикл
			...
			НоваяСтрока.ПозицияКорабля1 = ЯчейкаКорабля1;
			НоваяСтрока.ПозицияКорабля2 = ЯчейкаКорабля2;
	...
	РасстояниеМеждуКораблями.Вставить("ПозицияКорабля1", ТаблицаРезультатов[0].ПозицияКорабля1);
	РасстояниеМеждуКораблями.Вставить("ПозицияКорабля2", ТаблицаРезультатов[0].ПозицияКорабля2);
	...
	РасстояниеМеждуКораблями.Вставить("МаксПозицияКорабля1", ТаблицаРезультатов[0].ПозицияКорабля1);
	РасстояниеМеждуКораблями.Вставить("МаксПозицияКорабля2", ТаблицаРезультатов[0].ПозицияКорабля2);

	// Максимальное от ближайшей ячейки
	
	РасстояниеМеждуКораблями.Вставить("МаксБЗначение"       , РасстояниеМеждуКораблями.Значение);
	РасстояниеМеждуКораблями.Вставить("МаксБПозицияКорабля1", РасстояниеМеждуКораблями.ПозицияКорабля1);
	РасстояниеМеждуКораблями.Вставить("МаксБПозицияКорабля2", РасстояниеМеждуКораблями.ПозицияКорабля2);
	
	Для Каждого ЯчейкаКорабля2 Из МассивКоординатКорабля2 Цикл
		Расстояние = РасстояниеЧебышев(РасстояниеМеждуКораблями.ПозицияКорабля1, ЯчейкаКорабля2);
		Если Расстояние > РасстояниеМеждуКораблями.МаксБЗначение Тогда
			РасстояниеМеждуКораблями.МаксБЗначение        = Расстояние;
			РасстояниеМеждуКораблями.МаксБПозицияКорабля2 = НовыйВектор(ЯчейкаКорабля2);
		КонецЕсли;
	КонецЦикла;

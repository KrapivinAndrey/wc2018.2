...
Процедура ДрафтДляЗмеи()
	...
	СборкаКорабля = СобратьКорбль("big_energy, big_health, big_blaster, big_engine, big_heal");
	...
	ВыбратьКорабль(СборкаКорабля["Id"], "20/" + КоординатаY+"/"+КоординатаZ, СборкаКорабля["Equipment"]);

...
Процедура ДрафтТаран()
	...
	ВыбратьКорабль(Корабль1["Id"], "3/" + КоординатаY + "/" + КоординатаZ, Корабль1["Equipment"]);
	ВыбратьКорабль(Корабль1["Id"], "6/" + КоординатаY + "/" + КоординатаZ, Корабль1["Equipment"]);
	ВыбратьКорабль(Корабль1["Id"], "9/" + КоординатаY + "/" + КоординатаZ, Корабль1["Equipment"]);
	ВыбратьКорабль(Корабль1["Id"], "12/" + КоординатаY + "/" + КоординатаZ, Корабль1["Equipment"]);
